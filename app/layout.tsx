...
export const metadata: Metadata = {
  ...
  description:
    "Ứng dụng học Tử Vi Đẩu Số: 24 bài học có sơ đồ, quiz tự chấm, công cụ lập lá số. Học offline, miễn phí.",
  ...
  openGraph: {
    ...
    description:
      "Lộ trình 4 giai đoạn, 24 bài học có sơ đồ tương tác + công cụ lập lá số. Học offline, miễn phí.",
    type: "website",
    locale: "vi_VN",
    siteName: "Tử Vi Học",
  },
  twitter: {
    ...
    title: "Tử Vi Học — Học Tử Vi Đẩu Số",
    description:
      "24 bài học có sơ đồ tương tác + công cụ lập lá số. Học offline, miễn phí.",
  },
